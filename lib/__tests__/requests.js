...
test('json auth', async () => {
  ...
  const booru = new Danbooru('http://alphabet:letter@safebooru.donmai.us')
  const response = await booru.json('445d6c4c8393b', {
    method: 'POST',
    body: requestBody
  })
